...
**My Enumerables** is a Ruby programme that loops through any given argument and outputs the result of the arguments.
...
- Loop through all given lists
- Loop Through any given list
